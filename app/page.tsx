...
export default function Home() {
  ...
  return (
    <div className={`min-h-screen font-sans overflow-x-hidden selection:bg-blue-600/35 selection:text-white transition-colors duration-500 ${theme === 'light'
      ...
      <main>
        ...
        {/* Partners Section (Case Study Endorsement) */}
        <PartnerSection theme={theme} lang={lang} />
