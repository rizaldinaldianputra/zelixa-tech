...
export default function EditProductPage() {
  ...
  if (fetching) return <div className="text-center p-8 text-slate-400">Loading product details...</div>;
    ...
    <div className="max-w-3xl mx-auto space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-slate-400 text-sm">Update catalog item details</p>
        </div>
      </div>
