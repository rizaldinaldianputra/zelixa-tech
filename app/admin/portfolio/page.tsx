  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <Link href="/admin/portfolio/create" className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg">Create New</Link>
      </div>
            ...
            {data.map((item: any) => (
              <tr key={item.id} className="hover:bg-slate-800/50">
                ...
                <td className="px-6 py-4 flex gap-3">
                  <Link href={`/admin/portfolio/${item.id}/edit`} className="text-blue-400 hover:text-blue-300">Edit</Link>
